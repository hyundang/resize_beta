...
const page_4 = [
  { src: "/imgs/item.png", text: "가로 스트라이프" },
  { src: "/imgs/item.png", text: "세로 스트라이프" },
  { src: "/imgs/item.png", text: "플로럴" },
  { src: "/imgs/item.png", text: "도트" },
  { src: "/imgs/item.png", text: "레오파드" },
  { src: "/imgs/item.png", text: "페이즐리" },
  { src: "/imgs/item.png", text: "스몰 체크" },
  { src: "/imgs/item.png", text: "빅 체크" },
  { src: "/imgs/item.png", text: "아가일" },
  { src: "/imgs/item.png", text: "꽈배기" },
...
const page_6 = [
  { src: "/imgs/item.png", text: "가죽" },
  { src: "/imgs/item.png", text: "앙고라" },
  { src: "/imgs/item.png", text: "나일론" },
  { src: "/imgs/item.png", text: "코듀로이" },
  { src: "/imgs/item.png", text: "벨벳" },
  { src: "/imgs/item.png", text: "린넨" },
  { src: "/imgs/item.png", text: "실크(새틴)" },
